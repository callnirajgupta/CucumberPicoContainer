...
public class PersonalDetailsPage {
	...
	public static final String SELECT_IMAGE_XPATH = "//button[contains(text(),'Select PASSPORT PICTURE')]";
	...
	public static void validatePersonalDetailsTitle() {
		...
		SeleniumUtil.PassTestStep(SeleniumUtil.getDriver(), Hooks.getExtentTest(),
				"Personal details page loaded successfully");
	}

	public static void validatePrefilledFieldsFromSignUpPage(String firstName, String surname, String gender,
			String country) {
		...
		Assert.assertEquals("The first name prefilled data is not matching", firstName,
				SeleniumUtil.getWebElement(By.name(FIRSTNAME_NAME)).getAttribute("value"));
		Assert.assertEquals("The surname prefilled data is not matching", surname,
				SeleniumUtil.getWebElement(By.name(SURNAME_NAME)).getAttribute("value"));
		Assert.assertEquals("The gender prefilled data is not matching", gender,
				SeleniumUtil.getWebElement(By.xpath(GENDER_XPATH)).getText().trim());
		Assert.assertEquals("The country name prefilled data is not matching", country,
				SeleniumUtil.getWebElement(By.xpath(NATIONALITY_XPATH)).getText().trim());
		SeleniumUtil.PassTestStep(SeleniumUtil.getDriver(), Hooks.getExtentTest(),
				" Prefilled data from Signup page loaded successfully");
	}

	public static void personalDetailFilling(String image, String title, String firstName, String middleName,
			String lastName,
			String otherName, String gender, String dob, String countryOfBirth, String cityOfBirth, String nationality,
			String religion, String homeTown, String region, String specialNeed, String comment) throws Throwable {
		...
		if (!("".equals(gender))) {
			...
			if (!("Select gender"
					.equalsIgnoreCase(SeleniumUtil.getWebElement(By.xpath(GENDER_XPATH)).getText().trim()))) {
				SeleniumUtil.getWebElement(By.xpath(GENDER_XPATH)).click();
		...
		if (!("".equals(countryOfBirth))) {
			...
			if ("SELECT COUNTRY"
					.equalsIgnoreCase(SeleniumUtil.getWebElement(By.xpath(COUNTRY_OF_BIRTH_XPATH)).getText().trim())) {
		...
		if (!("".equals(nationality))) {
			...
			if (!("SELECT NATIONALITY".equalsIgnoreCase(
					SeleniumUtil.getWebElement(By.xpath(NATIONALITY_SELECTED_TEXT_XPATH)).getText().trim()))
				...
				SeleniumUtil.wait(1000);
				SeleniumUtil.getWebElement(By.xpath(SELECT_LABEL_NATIONALITY_XPATH.replace("selectText", nationality)))
						.click();
		...
		if (!("".equals(religion))) {
			...
			if ("Select religion"
					.equalsIgnoreCase(SeleniumUtil.getWebElement(By.xpath(RELIGION_XPATH)).getText().trim())) {
		...
		SeleniumUtil.PassTestStep(SeleniumUtil.getDriver(), Hooks.getExtentTest(),
				"Personal details fill form successfully");

	}

	public static void personalDetailClear(String image, String title, String firstName, String middleName,
			String lastName,
			String otherName, String gender, String dob, String countryOfBirth, String cityOfBirth, String nationality,
			String religion, String homeTown, String region, String specialNeed, String comment) throws Throwable {
		...
		SeleniumUtil.PassTestStep(SeleniumUtil.getDriver(), Hooks.getExtentTest(),
				"Personal details clear form successfully");
	...
	public static String getErrorMessage() {
		SeleniumUtil.wait(2000);
		SeleniumUtil.PassTestStep(SeleniumUtil.getDriver(), Hooks.getExtentTest(),
				"Personal details error loaded successfully");
	...
	public static void ClickLogoutInPersonalDetailPage() {
		...
		SeleniumUtil.PassTestStep(SeleniumUtil.getDriver(), Hooks.getExtentTest(),
				"ClickLogoutInPersonalDetailPage successfully");
	}
